          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <a href="{{ route('gift.find') }}">
              <div class="icon-box iconbox-blue">
                ...
                <h4>Encontre suas dicas</h4>
                <p>Nós temos várias dicas para: o dia dos pais, para alguém de touro, para quem gosta de música ou para aquele casal especial. Clique e encontre dicas agora mesmo</p>
              </div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <a href="{{ route('gift.create') }}">
              <div class="icon-box iconbox-orange ">
                ...
                <h4>Peça dicas especiais</h4>
                <p>Responda algumas perguntas rápidas para a nossa nossa IA buscar as melhores dicas de presente para você. Clique agora mesmo, é rápido!</p>
              </div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <a href="#contact">
              <div class="icon-box iconbox-pink">
                ...
                <p>Ficou com alguma dúvida? Seu precisa de algo diferente? Use um dos nossos canais de atendimento que vamos ajudar</p>
              </div>
          </div>
          </a>
        </div>
